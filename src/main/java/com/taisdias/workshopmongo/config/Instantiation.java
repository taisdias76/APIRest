package com.taisdias.workshopmongo.config;
...
import com.taisdias.workshopmongo.dto.AuthorDTO;
import com.taisdias.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("21/06/2024"), new AuthorDTO(alex));
